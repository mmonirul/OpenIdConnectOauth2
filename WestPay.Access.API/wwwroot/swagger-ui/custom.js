(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "http://westpay.se/";
            logo[0].target = "_blank";

            // Section 02 - Set logo
            logo[0].children[0].alt = "Westpay";
            logo[0].children[0].src = "/swagger-ui/resources/westpay-favicon-32x32.png";
            document.querySelectorAll('.topbar-wrapper a> span')[0].innerText = "Westpay Api";

            // Section 03 - Set 32x32 favicon
            var linkIcon32 = document.createElement('link');
            linkIcon32.type = 'image/png';
            linkIcon32.rel = 'icon';
            linkIcon32.href = '/swagger-ui/resources/westpay-favicon-32x32.png';
            ...
            linkIcon16.rel = 'icon';
            linkIcon16.href = '/swagger-ui/resources/westpay-favicon-32x32.png';
